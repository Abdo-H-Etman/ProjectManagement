        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    KeyHash = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_project_invitations_users_InvitedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_project_members_users_InvitedById",
                        column: x => x.InvitedById,
                        principalTable: "users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_favorites", x => new { x.UserId, x.ProjectId });
                    table.ForeignKey(
                        name: "FK_user_favorites_projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_activity_logs_tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "tasks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_checklist_items_tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_activity_logs_TaskId",
                table: "activity_logs",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_activity_logs_Type_CreatedAt",
                table: "activity_logs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_checklist_items_TaskId",
                table: "checklist_items",
                column: "TaskId");

            migrationBuilder.CreateIndex(
                name: "IX_checklist_items_TaskId_IsCompleted",
                table: "checklist_items",
                columns: new[] { "TaskId", "IsCompleted" });

            migrationBuilder.CreateIndex(
                name: "IX_checklist_items_TaskId_Position",
                table: "checklist_items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_project_invitations_Email_ProjectId",
                table: "project_invitations",
                columns: new[] { "Email", "ProjectId" });

            migrationBuilder.CreateIndex(
                name: "IX_project_invitations_InvitedById",
                table: "project_invitations",
                column: "InvitedById");

            migrationBuilder.CreateIndex(
                name: "IX_project_invitations_IsAccepted_ExpiresAt",
                table: "project_invitations",
                columns: new[] { "IsAccepted", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_project_invitations_ProjectId",
                table: "project_invitations",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_project_members_InvitedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_project_tags_CreatedAt",
                table: "project_tags",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_projects_IsArchived_IsDeleted",
                table: "projects",
                columns: new[] { "IsArchived", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_time_entries_TaskId_IsBillable",
                table: "time_entries",
                columns: new[] { "TaskId", "IsBillable" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_time_entries_UserId_StartTime",
                table: "time_entries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_favorites_CreatedAt",
                table: "user_favorites",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_user_favorites_ProjectId",
                table: "user_favorites",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_webhooks_LastTriggeredAt",
                table: "webhooks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_webhooks_ProjectId_IsActive",
                table: "webhooks",
